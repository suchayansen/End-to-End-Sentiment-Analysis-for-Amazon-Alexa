...
def single_prediction(predictor, scaler, cv, text_input):
    ...
    print("Prediction probabilities:", y_predictions)
    print("Shape:", y_predictions.shape)
    print("Class 0 probability:", y_predictions[0][0])
    print("Class 1 probability:", y_predictions[0][1])
    
    predicted_class = y_predictions.argmax(axis=1)[0]
    print("Predicted class (argmax):", predicted_class)
    
    # Also try direct predict
    direct_pred = predictor.predict(X_prediction_scl)[0]
    print("Direct predict result:", direct_pred)
    print("=" * 50)
